...
class ComposerStaticInitbcbbf0a7b711b47cef5007c7aa177fa8
{
    public static $classMap = array (
        'Audit' => __DIR__ . '/..' . '/bcosca/fatfree-core/audit.php',
        'Auth' => __DIR__ . '/..' . '/bcosca/fatfree-core/auth.php',
        'AuthController' => __DIR__ . '/../..' . '/controllers/config/AuthController.php',
        ...
        'MainController' => __DIR__ . '/../..' . '/controllers/config/MainController.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->classMap = ComposerStaticInitbcbbf0a7b711b47cef5007c7aa177fa8::$classMap;
